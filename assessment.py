...
def hometown(town):
    """Evaluate Taiwan as hometown to True, and False otherwise"""
...
def hometown_comparison_greeting(town, first_name, last_name):
    """Compare home town with my designated hometown and return greeting"""
...
def shipping_cost(fruit):
    ...
    verify_berry = is_berry(fruit)

    if verify_berry == True:
        return 0
    else:
        return 5
